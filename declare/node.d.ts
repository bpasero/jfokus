...
declare module "https" {
    ...
    export function request(options: RequestOptions, callback?: Function): http.ClientRequest;
    export function get(options: RequestOptions, callback?: Function): http.ClientRequest;
...
declare module "fs" {
    ...
    export function utimes(path: string, atime: Date, mtime: Date, callback?: Function): void;
    export function utimesSync(path: string, atime: Date, mtime: Date): void;
    export function futimes(fd: number, atime: Date, mtime: Date, callback?: Function): void;
    ...
    export function write(fd: number, buffer: string, position: number, callback?: (err: Error, written: number, buffer: NodeBuffer) =>any): void;
    ...
    export function writeSync(fd: number, buffer: string, position?: number): number;
...
declare module "stream" {
	...
	export interface NodeStream extends events.NodeEventEmitter {
		pipe(destination: WritableStream, options?: { end?: boolean; }): void;
	}
    ...
    export interface ReadableStream extends NodeStream {
        readable: boolean;
        setEncoding(encoding: string): void;
        pause(): void;
        resume(): void;
...
declare module "util" {
	...
	export function pump(readableStream:ReadableStream, writeableStream:WritableStream, callback:(error:Error)=>void);
